...
#pragma warning restore SA1633 // File should have header
{
    ...
    /// </summary>
    public class DBConnectionConsole
    {
        private DBConnectionConsole instance = null;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DBConnectionConsole"/> class.
        ...
        public void EstablishConnection()
        {
                ...
                || this.connection.State.ToString() != "open")
            {
                try
                {
                    this.connectionProperties = ConfigurationManager.ConnectionStrings["Gießformkonfigurator"].ToString();
